...
public final class Program1Parse1 extends Program1 {
    ...
    private static String parseInstruction(Queue<String> tokens,
        ...
        String instructionName = tokens.dequeue(); // dequeue program.context.pair.key();

        String primitiveCalls = "move,turnleft,turnright,turnback,skip";

        boolean isPrimitive = primitiveCalls.indexOf(instructionName) != -1;
        ...
        tokens.dequeue(); //dequeue program.context.pair.key();
    ...
    public void parse(Queue<String> tokens) {
        ...
        tokens.dequeue();// dequeue "Program"

        String pName = tokens.dequeue();
        this.setName(pName);
        ...
        while (tokens.front().equals("INSTRUCTION")) {
            ...
            ctxt.add(instructionName, instruction);
        }
        ...
        Reporter.assertElseFatalError(tokens.front().equals(pName),
