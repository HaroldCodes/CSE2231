...
public class Program2 extends ProgramSecondary {
    ...
    public final Map<String, Statement> newContext() {
        ...
        Map<String, Statement> c = this.context.newInstance();
        // Fix this line to return the result.
        return c;
    }
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        Map<String, Statement> swap = this.context.newInstance();
        swap.transferFrom(c);

        c.transferFrom(this.context);
        this.context.transferFrom(swap);
    ...
    public final Statement newBody() {
        ...
        Statement ctxt = this.body.newInstance();
    ...
    public final void swapBody(Statement b) {
        ...
        Statement swap = this.body.newInstance();
        swap.transferFrom(b);

        b.transferFrom(this.body);
        this.body.transferFrom(swap);
